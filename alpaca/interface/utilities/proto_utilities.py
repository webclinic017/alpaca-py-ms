...
from alpaca.conf import config
...
class ProtoParser:
    ...
    def __init__(self):
        ...
        self.proto_file = config.ALPACA_MS_ROOT / 'alpaca/interface/interface.proto'
    ...
    def write_json(self):
        """Write JSON file to AUTOTRADER_GENERATED directory"""
        json_file = config.ALPACA_MS_ROOT / 'alpaca/interface/generated/interface.json'
        print("Writing interface JSON file to {}...".format(json_file), end='')
        with open(json_file, 'w') as fp:
            json.dump(self.message_dict, fp, indent=3)
        print("Success")
        ...
        self.message_dict[type_name] = \
            {
                ...
                'Channel': channel,
                'Summary': summary,
                'Fields': ProtoParser._parse_fields(msg_fields)
            }
